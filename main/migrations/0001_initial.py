# Generated by Django 2.2.9 on 2020-02-03 08:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Home', 'Home'), ('Personal', 'Personal'), ('Work', 'Work'), ('Other', 'Other')], default='Personal', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('position', models.IntegerField(default=1, null=True)),
                ('type', models.CharField(choices=[('Home', 'Home'), ('Mobile', 'Mobile'), ('Work', 'Work'), ('Pager', 'Pager'), ('Other', 'Other')], default='Mobile', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.Phone')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distribution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.Distribution')),
                ('email', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.Email')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linked_rsvp', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.Message')),
                ('period', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.Period')),
                ('rsvp_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.RsvpTemplate')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outbound', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.OutboundSms')),
            ],
            options={
                'abstract': False,
            },
