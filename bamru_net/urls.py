...
urlpatterns = [
    ...
    path('member/<int:member>/certs/new', views.CertCreateView.as_view(), name='new_cert'),
    path('member/<int:member>/certs/<int:pk>', views.CertEditView.as_view(), name='edit_cert'),
