# Generated by Django 2.0.5 on 2018-06-01 01:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('typ', models.CharField(choices=[('TM', 'Technical Member'), ('FM', 'Field Member'), ('T', 'Trainee'), ('R', 'Reserve'), ('S', 'Support'), ('A', 'Associate'), ('G', 'Guest'), ('MA', 'Member Alum'), ('GA', 'Guest Alum'), ('MN', 'Member No-contact'), ('GN', 'Guest No-contact')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('typ', models.CharField(choices=[('Home', 'Home'), ('Mobile', 'Mobile'), ('Work', 'Work'), ('Other', 'Other')], max_length=255)),
                ('position', models.IntegerField(default=1)),
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
