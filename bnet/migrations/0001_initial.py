# Generated by Django 2.0.5 on 2018-06-21 03:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linked_rsvp', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='bnet.Message')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='phone',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bnet.Phone'),
        ),
        migrations.AddField(
            model_name='message',
            name='period',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='bnet.Period'),
        ),
        migrations.AddField(
            model_name='message',
            name='rsvp_template',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='bnet.RsvpTemplate'),
        ),
        migrations.AddField(
